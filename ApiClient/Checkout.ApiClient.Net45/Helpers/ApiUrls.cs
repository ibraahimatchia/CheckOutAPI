namespace Checkout
{
    public class ApiUrls
    {
        ...
        private static string _ShoppingsApiUri;
        private static string _ShoppingApiUri;
        ...
        public static void ResetApiUrls()
        {
            ...
            _ShoppingsApiUri = null;
            _ShoppingApiUri = null;
        }
        ...
        public static string Shoppings
            => _ShoppingsApiUri ?? (_ShoppingsApiUri = string.Concat(AppSettings.BaseApiUri, "/Shopping"));

        public static string Shopping
            => _ShoppingApiUri ?? (_ShoppingApiUri = string.Concat(AppSettings.BaseApiUri, "/Shopping/{0}"));
    }
}