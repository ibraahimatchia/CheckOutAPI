...
namespace Tests
{
    public class TestHelper
    {
        ...
        /*
         * Test data for Shopping service
         */

        public static Shopping CreateItem()
        {
            return new Shopping()
            {
                ItemName = "Pepsi",
        ...
        public static Shopping CreateForUpdateItemName()
        {
            return new Shopping()
            {
                ItemName = "Headset",
        ...
        public static Shopping UpdateItemName()
        {
            return new Shopping()
            {
                ItemName = "Headset and Mic",
                Quantity = 3000
            };
        }

        public static Shopping CreateForUpdateItemID()
        {
            return new Shopping()
            {
                ItemName = "CPU",
        ...
        public static Shopping UpdateItemID()
        {
            return new Shopping()
            {
                ItemName = "CPU and Mouse",
                Quantity = 1000
            };
        }
